...
$(document).ready(function(){
    $("#btn-refresh").click(function (e){
        ...
        $.post('<?=$this->config->item("base_url")?>/oauth2/RefreshToken', data, function (d){
    ...
    $('#btn-authorize').click(function (e){
        ...
        $.post('<?=$this->config->item("base_url")?>/oauth2/authorize/token', data, function (d){
    ...
    $('#btn-resource').click(function (e){
        ...
        $.post('<?=$this->config->item("base_url")?>/oauth2/resource', data, function (d){
    ...
    $('#btn-resource-limit').click(function (e){
        ...
        $.post('<?=$this->config->item("base_url")?>/oauth2/resource/limit', data, function (d){
            console.log("Get Authorize => ", d);
            $('#return-resource').html(JSON.stringify(d));
        },"json");      
    });
    ...
    $('#btn-PasswordCredentials').click(function (e){
        var data = { grant_type: "password", username: "bgeneto", password: "123123", client_id: 'testclient', client_secret:'testpass', scope:'userinfo cloud file node' };
        $.post('<?=$this->config->item("base_url")?>/oauth2/PasswordCredentials', data, function (d){
    ...
    $("#btn-ClientCredentials").click(function (e){
        ...
        $.post('<?=$this->config->item("base_url")?>/oauth2/ClientCredentials', data, function (d){
            //d = d.JSON.parse(d);
